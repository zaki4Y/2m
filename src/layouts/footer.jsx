...
export const Footer = () => {
  return (
    <>
      <footer class="bg-[#0b0e37] text-white  px-4 font-sans tracking-wide h-[38vh] p-5">
        <div class="text-center">
          <h6 class="text-base">Stay connected with us:</h6>

          <ul class="flex flex-wrap justify-center gap-x-8 gap-4 my-8">
            <li>
              <a href="https://www.facebook.com/2m.officiel/?locale=fr_FR" class="text-xl hover:text-gray-400">
                <svg
            ...
            <li>
              <a href="https://www.linkedin.com/company/2m-tv/?originalSubdomain=ma" class="text-xl hover:text-gray-400">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="inline w-7 h-7"
                  viewBox="0 0 176 176"
            ...
            <li>
              <a href="https://www.instagram.com/2mtv/?hl=fr" class="text-xl hover:text-gray-400">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="inline w-7 h-7"
                  viewBox="0 0 24 24"
            ...
            <li>
              <a href="https://x.com/2MInteractive?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor" class="text-xl hover:text-gray-400">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="inline w-7 h-7"
