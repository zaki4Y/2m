...
export const TeamsSection = () => {
    ...
    return (
        <>
        <body className='dark'>
        <div class="font-[sans-serif] max-w-5xl max-lg:max-w-4xl  max-sm:max-w-sm mx-auto  p-5">
            <div class="max-w-2xl mx-auto text-center">
                <h2 class="text-white text-3xl font-extrabold ">Meet our team</h2>
                <p class="text-white text-sm mt-4 leading-relaxed">Meet our team of professionals to serve you.</p>
            </div>
            ...
            <div class="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-x-6 gap-y-16 text-center mt-24">
            {
                ...
                <div class="bg-gray-200 relative rounded" key={index}>
                    <img src={element.images} class="w-32 h-32 rounded-full inline-block -mt-12" />

                    <div class="py-4">
                        <h4 class="text-gray-800 text-base font-extrabold">{element.Name}</h4>
                        <p class="text-gray-800 text-sm  mt-1 ">{element.discription}</p>
